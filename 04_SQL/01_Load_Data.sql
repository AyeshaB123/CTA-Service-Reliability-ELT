...
FROM 'C:\a_Final_Portfolio\CTA\GitHubContent\01_SampleDatasets\MasterAlerts.csv'
WITH (
	FIRSTROW = 2,
	FIELDTERMINATOR = ',',
	ROWTERMINATOR = '0x0a',
...
FROM 'C:\a_Final_Portfolio\CTA\GitHubContent\01_SampleDatasets\LiveLatestAlerts.csv'
WITH (
    FIRSTROW = 2,
    FIELDTERMINATOR = ',',
    ROWTERMINATOR = '0x0a',
