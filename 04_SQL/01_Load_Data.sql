...
-- The purpose of this script is to load data into 2 tables - Staging.Master_Alerts and Live.Live_Latest_Alerts. The source CSV files for both are located in the "Sample Dataset" folder.
-- Download the datasets and update the file paths below to match where you saved them.


-- Load data in Master Alerts table
BULK INSERT Staging.Master_Alerts
...
-- Using a staging table here because Live.Live_Latest_Alerts has computed columns, and BULK INSERT can't load directly into a table that has computed columns.
...
INSERT INTO Live.Live_Latest_Alerts(
